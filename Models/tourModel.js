...
const tourSchema = new mongoose.Schema({
  name: {
    ...
    unique: true,
    trim: true,
    maxlength: [40, "The name is too long! maximum: 40"],
    minlength: [10, "The name is too short! minimum: 10"],
  ...
  priceDiscount: {
    ...
    validate: {
      ...
      message: 'Discoun price should be lower than regular price.'
    }
  },
  summary: {
    type: String,
...
tourSchema.pre(/^find/, function (next) {
  ...
  // Show guides fields with the referenced users
